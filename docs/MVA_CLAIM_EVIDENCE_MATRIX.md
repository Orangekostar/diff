...
| Global task-aware mask improves acquisition | A4 evidence | LOCKED |
| Deployable policy imitates the oracle | A5 evidence | LOCKED |
| Laminate context improves acquisition | A6/A7 structured transfer | LOCKED |
