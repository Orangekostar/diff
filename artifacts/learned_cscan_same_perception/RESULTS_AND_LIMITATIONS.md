...
The pilot completed real training and untouched TEST evaluation, but it does not support the main learned-planning hypothesis. All outcome labels are `SAME_READER_SELF_CONSISTENCY` proxies because none of the 60 references has independent review. Formal effects and formal confidence intervals are therefore null.

| Status | Result |
|---|---|
| Execution | `TRAINED_AND_EVALUATED` |
| Reference | `PROXY_ONLY` |
| Reader v2 | `FUNCTIONAL` (`120/120` nondegenerate full-input task readouts) |
...
| Method | LOCATE AUSC | LOCATE SR@0.10 | LOCATE SR@0.40 | CHARACTERIZE AUSC | CHARACTERIZE SR@0.10 | CHARACTERIZE SR@0.40 |
|---|---:|---:|---:|---:|---:|---:|
| `R_BALANCED` | 0.629819 | 0.4583 | 0.5833 | 0.467930 | 0.1250 | 0.2500 |
| `L_BC` | 0.809955 | 0.6250 | 0.7500 | 0.548819 | 0.0833 | 0.4167 |
| `L_CTG` | 0.413091 | 0.0833 | 0.2917 | 0.309835 | 0.0000 | 0.0417 |
...
This conclusion is limited to a retrospective reused cohort, same-reader proxy labels, one seed after a negative VALID gate, and normalized image-plane acquisition/route costs. There is no independently reviewed damage reference, prospective scanner execution, physical travel-time model, causal damage validation, new-material transfer test, or statistical basis for a formal detection claim. Independent review can rescore the frozen TEST reports, but changing training labels or reader calibration requires a new versioned run.
