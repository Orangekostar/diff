...
The current map has no `INTERNAL_ONLY` claims. The complete claim-level
classification is:
...
| `U3_RECONSTRUCTION_ORACLE` | `MAIN_REQUIRED` |
| `U3_HEADROOM_RETENTION` | `MAIN_OPTIONAL` |
| `U4_ORACLE_CAI_SPECIFICITY` | `MAIN_REQUIRED` |
| `U4_ORACLE_IMAGE_SPECIFICITY` | `MAIN_REQUIRED` |
...
| `O3_REAL_MINUS_RECONSTRUCTION` | `MAIN_OPTIONAL` |
