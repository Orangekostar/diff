...
| I-B CAI-specific measurement value beyond field content | Acquisition opportunity is heterogeneous, and CAI priority is not reducible to the registered field-content reference | `U3_UNIFORM_ORACLE`; `U3_RECONSTRUCTION_ORACLE`; `U4_ORACLE_CAI_SPECIFICITY`; `U4_ORACLE_IMAGE_SPECIFICITY` | `U3_HEADROOM_RETENTION` | `U4_LEARNED_SPECIFICITY_BOUNDARY` |
...
- Figure 4 contains O3/O4 controls, A1/A2 evidence, and subordinate A4
  calibration. A3 remains supplement-only.
