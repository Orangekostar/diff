...
Observable & Is value observable from legal state? & static legal-state scorer vs strict-OOF teacher values & Spearman rho -0.0196 & [-0.0591, 0.0195] & 3/6 & strict-OOF static scorer & Static value observability is not supported. \\
 &  & conditional teacher values from initial to final tested checkpoint & turnover 0.704; rank 0.405; top-5 0.307 & descriptive checkpoint evolution & 276 specimens; 6 domains & strict-OOF retrospective teacher & True conditional measurement value evolves with acquisition state. \\
